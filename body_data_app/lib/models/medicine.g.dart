...
extension MedicineQueryFilter
  ...
  QueryBuilder<Medicine, Medicine, QAfterFilterCondition> timestampEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Medicine, Medicine, QAfterFilterCondition> timestampGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Medicine, Medicine, QAfterFilterCondition> timestampLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Medicine, Medicine, QAfterFilterCondition> timestampBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MedicineQuerySortBy on QueryBuilder<Medicine, Medicine, QSortBy> {
  ...
  QueryBuilder<Medicine, Medicine, QAfterSortBy> sortByTimestamp() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timestamp', Sort.asc);
    });
  }

  QueryBuilder<Medicine, Medicine, QAfterSortBy> sortByTimestampDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MedicineQuerySortThenBy
  ...
  QueryBuilder<Medicine, Medicine, QAfterSortBy> thenByTimestamp() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timestamp', Sort.asc);
    });
  }

  QueryBuilder<Medicine, Medicine, QAfterSortBy> thenByTimestampDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timestamp', Sort.desc);
    });
  }
...
extension MedicineQueryWhereDistinct
  ...
  QueryBuilder<Medicine, Medicine, QDistinct> distinctByTimestamp() {
    return QueryBuilder.apply(this, (query) {
...
extension MedicineQueryProperty
  ...
  QueryBuilder<Medicine, double, QQueryOperations> dosageProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Medicine, DateTime, QQueryOperations> timestampProperty() {
    return QueryBuilder.apply(this, (query) {
